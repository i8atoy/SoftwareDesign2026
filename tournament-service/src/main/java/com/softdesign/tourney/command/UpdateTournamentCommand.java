...
public class UpdateTournamentCommand implements TournamentCommand {

    private final TournamentCommandService service;
    private final TournamentDto dto;

    public UpdateTournamentCommand(TournamentCommandService service, TournamentDto dto) {
